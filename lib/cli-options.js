exports.definitions = [
  ...
  {
    name: 'secureProtocol', type: String, group: 'server',
    description: 'Optional SSL method to use, default is "SSLv23_method". The possible values are listed as SSL_METHODS, use the function names as strings'
  },
  {
    name: 'ciphers', type: String, group: 'server',
