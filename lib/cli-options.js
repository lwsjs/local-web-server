exports.definitions = [
  ...
  {
    name: 'confile', type: String, typeLabel: '[underline]{file}', defaultValue: 'local-web-server',
    description: 'Looking config file. Full config file name will be \'.<confile>.json\'. Default \'local-web-server\'.', group: 'misc'
  },
  {
